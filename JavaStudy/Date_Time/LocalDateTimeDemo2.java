...
public class LocalDateTimeDemo2 {
	public static void main(String[] args) {
		// 현재 시각
		LocalDateTime today = LocalDateTime.of(2023, 4, 25, 11, 20);
		
		// 항공 1편의 출발 시간
		LocalDateTime flight1 = LocalDateTime.of(2023, 5, 14, 11, 15);
		
		// 항공 2편의 출발 시간
		LocalDateTime flight2 = LocalDateTime.of(2023, 5, 13, 15, 30);
